    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, default='email@mail.ru', max_length=254, verbose_name='E-mail')),
                ('image', models.ImageField(blank=True, default='img/no_avatar.jpeg', upload_to='avatar/%Y/%m/%d/', verbose_name='Аватарка')),
